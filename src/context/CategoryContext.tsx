...
export const CATEGORY_LABELS = ['Rings', 'Necklaces', 'Bracelets', 'Earrings'] as const
export type CategoryLabel = (typeof CATEGORY_LABELS)[number]
export type CategoryKey = 'ring' | 'necklaces' | 'bracelets' | 'earrings'
...
export function CategoryProvider({ children }: { children: ReactNode }) {
  const [categoryKey, setCategoryKeyState] = useState<CategoryKey>('necklaces')
